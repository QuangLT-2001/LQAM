      ...
      <>
        <Form fluid onChange={setState} formValue={state} ref={formRef}>
          <Form.Group controlId="name-9" className="d-flex w-100 align-items-center">
            <Form.ControlLabel style={{ minWidth: '200px' }}>
              Tổ chức
          ...
          <Form.Group controlId="name-9" className="d-flex w-100 align-items-center">
            <Form.ControlLabel style={{ minWidth: '200px' }}>
              Tọa độ<span className="text-danger">*</span>
              <br />
              <span>(Lat, Long)</span>
            </Form.ControlLabel>
            <Form.Control
          ...
          <Form.Group title="status" controlId="name-9" className="d-flex align-items-center">
            <Form.ControlLabel style={{ minWidth: '200px' }}>Trạng thái</Form.ControlLabel>
            <Form.Control
    ...
    <FormWrapper classNames="frm">
      <Modal open={open} onClose={handleClickCancel}>
        ...
        <Modal.Footer className="p-3">
          {state.id ? (
            <Button onClick={handleClickUpdate} color="green" appearance="primary">
              Cập nhật
            </Button>
          ) : (
            <Button onClick={handleClickSave} color="green" appearance="primary">
              Lưu
            </Button>
          )}
