...
const count = data.length
    ...
    const getData = () => {
     ...
     return <MapWorkListWrapper className="page_map_work">

          <FormMapWork url="managerTodo" state={state} setState={setState} open={open} handleCloseOpen={handleCloseOpen} setOpen={setOpen} />
